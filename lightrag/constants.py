...
DEFAULT_MAX_ASYNC = 8  # Default maximum async operations (increased from 4)
DEFAULT_MAX_PARALLEL_INSERT = 4  # Default maximum parallel insert operations (increased from 2)

# Embedding configuration defaults
DEFAULT_EMBEDDING_FUNC_MAX_ASYNC = 16  # Default max async for embedding functions (increased from 8)
DEFAULT_EMBEDDING_BATCH_NUM = 20  # Default batch size for embedding computations (increased from 10)

# Gunicorn worker timeout
DEFAULT_TIMEOUT = 600  # Increased from 300 to 600 seconds

# Default llm and embedding timeout
DEFAULT_LLM_TIMEOUT = 300  # Increased from 180 to 300 seconds
DEFAULT_EMBEDDING_TIMEOUT = 60  # Increased from 30 to 60 seconds

# Rate limit handling for OpenAI API (200k tokens/min limit)
DEFAULT_LLM_REQUEST_DELAY = 0.5  # Delay between LLM requests in seconds (helps avoid rate limits)
