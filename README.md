...
## � MedQA-USMLE Benchmark Reproduction Kit

Complete end-to-end pipeline for evaluating LightRAG on medical knowledge extraction and question answering.

<div align="center" style="margin: 20px 0;">
  <a href="./reproduce/steps_replicacao/README.md" style="text-decoration: none;">
    <img src="https://img.shields.io/badge/📚%20REPRODUCTION%20KIT-Complete%20Guide-ff6b6b?style=for-the-badge&logoColor=white&labelColor=1a1a2e" alt="Reproduction Kit">
  </a>
</div>

This kit includes:
- 4 ready-to-run Python scripts for the complete pipeline
- Detailed documentation of the indexing, filtering, inference, and evaluation steps
- Pre-configured prompts for medical domain knowledge extraction
